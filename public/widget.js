(function () {
  ...
  win.innerHTML = `
    <div id="varro-chat-header"><span>Varro</span> — digitale host <div id="varro-chat-close">×</div></div>
  ...
  const closeBtn = document.getElementById("varro-chat-close");
  ...
  // Auto-open once, smoothly, after the user scrolls a bit (desktop only)
  window.addEventListener("scroll", function () {
    if (!varroOpenedOnScroll && window.scrollY > 300 && window.innerWidth > 768) {
